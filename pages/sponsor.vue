<template>
    ...
    <main class="row justify-content-center">
      <section class="col-lg-7">
        <section class="SupportSection">
          ...
          <p>
            2022 was our first in-person event in three years and we
            ...
            of hacks at:
            <a href="https://bitcamp2022.devpost.com/">https://bitcamp2022.devpost.com/</a>!
          </p>
          <p>
          ...
          <p>
            ...
            interested in becoming an official sponsor for Bitcamp 2024, we'd
  ...
  '2 min',
            ...
            <ProspectusRow :categoryName="'Dedicated Prize Category Office Hours'" :tierNames="[
              'Byte',
              'Kilo',
              'Mega',
              'Giga',
            ...
            <ProspectusRow :categoryName="'Provide an Additional Prize'" :tierNames="[
              'Byte',
              'Kilo',
              'Mega',
              'Giga',
            ...
            <ProspectusBottomRow :categoryName="'Interview Slots'" :tierNames="[
              'Byte',
              'Kilo',
              'Mega',
              'Giga',
  ...
  '2 events',
            ...
            <ProspectusRow :categoryName="'Logo on Shirt and Website'" :tierNames="[
              'Byte',
              'Kilo',
              'Mega',
              'Giga',
  ...
  'check-w',
            ...
            <ProspectusRow :categoryName="'Distribute Marketing Materials and Merch'" :tierNames="[
              'Byte',
              'Kilo',
              'Mega',
              'Giga',
  ...
  '',
            ...
            <ProspectusRow :categoryName="'Premium Table Location'" :tierNames="[
              'Byte',
              'Kilo',
              'Mega',
              'Giga',
